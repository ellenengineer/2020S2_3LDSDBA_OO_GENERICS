...
namespace TesteOO
{
    class Program
    {
        ...
        /// <summary>
        /// Exemplo 1 -Simulação da herança e polimorfismo
        /// </summary>
        static void HerancaPolimorfismo()
        {
            clsPessoa objPF = new clsPessoaFisica();
            objPF.Nome = "Ellen";
            objPF.DataNascimentoFundacao = new DateTime(1986, 01, 28);


            clsPessoa objPj = new clsPessoaJuridica();
            objPj.Nome = "Cabeleilela Leila";
            objPj.DataNascimentoFundacao = new DateTime(1990, 05, 24);


            string retornoPJ = objPj.Nascer(objPj.DataNascimentoFundacao);
            string retornoPF = objPF.Nascer(objPF.DataNascimentoFundacao);
        ...
        static void TesteOOFelino()
        {
            ...
            clsFelino objGatinho = new clsFelino();
            objGatinho.Nome = "Nick";
            objGatinho.QtdePatas = 4;
            objGatinho.IsCarnivoro = true;
            objGatinho.TipoFelino = TipoFelino.Pequeno;
            objGatinho.DtNasc = new DateTime(2020, 08, 20);


            Console.WriteLine(objGatinho.Nascer(objGatinho.DtNasc));
            Console.WriteLine(objGatinho.Crescer());
